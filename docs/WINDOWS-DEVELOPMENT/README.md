...
### 環境設定
- **[01-Windows正式環境手冊](./01-Windows開發環境完整手冊.md)** - Windows 環境完整設定指南
  - 環境準備
  - 資料庫連接設定
  - 應用程式啟動
  - 錯誤診斷
...
### 環境切換
- **[03-環境切換指南](./03-環境切換指南.md)** - Mac 和 Windows 環境切換步驟
  - 從 Mac 切換到 Windows
  - 從 Windows 切換到 Mac
  - 注意事項

### 資料庫遷移
- **[04-資料庫遷移指南](./04-資料庫遷移指南.md)** - Mac Docker 資料庫遷移到正式區 SQL Server
  - 備份資料庫
  - 遷移資料
  - 驗證資料完整性
...
3. **Windows 正式測試**：在 Windows 環境拉取程式碼，連接正式區 SQL Server 進行正式測試
...
### Mac 環境（參考用）
- [Mac 開發環境](../MAC-DEVELOPMENT-ONLY/) - Mac 本地開發測試環境（僅供參考，不要使用）

---

**開始使用**：請先閱讀 [Windows 正式環境手冊](./01-Windows開發環境完整手冊.md)
