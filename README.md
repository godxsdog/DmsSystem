...
所有技術文件已整理至 [`docs/`](./docs/) 資料夾：

- [📖 文件目錄](./docs/README.md) - 所有文件的索引
- [🏗️ 架構指南](./docs/01-架構指南.md) - 完整的系統架構說明
- [🗄️ 資料庫配置](./docs/02-資料庫配置.md) - 資料庫設定指南
- [📊 測試資料載入](./docs/03-測試資料載入.md) - 如何載入測試資料
- [🧪 測試指南](./docs/04-測試指南.md) - 測試相關說明
- [✅ 專案完成總結](./docs/05-專案完成總結.md) - 開發完成情況
