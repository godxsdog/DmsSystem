...
def col(d, k):
    ...
    chinese_to_english = {
        ...
        '基金英文名稱': 'ENAME',
        '基金簡簡稱': 'SSNAME',
        'Fund Code': 'G_FUNDCODE',  # Fund Code 映射到 G_FUNDCODE
        'ISIN Code': 'ISIN_CODE',
        '基金經理公司': 'AMC_NO',
        '基金專戶名稱': 'AC_NAME',
        '基金保管機構': 'CUSTODIAN',
...
def main():
    ...
    for i, r in enumerate(rows):
        ...
        fund_code = esc(col(r, 'G_FUNDCODE'))  # Fund Code (映射到 G_FUNDCODE)
        ...
        # G_FUNDCODE: 設置為 Fund Code
        if fund_code:
            set_val('G_FUNDCODE', f"'{fund_code}'")
        else:
            set_val('G_FUNDCODE', "null")
